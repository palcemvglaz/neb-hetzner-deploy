...
export default function BeginnerQuestionnairePage() {
  ...
  const testStudents = [
    ...
    { email: 'tourist@test.com', name: 'Турист', description: 'Подорожі' }
  ]
          ...
          <div className="bg-gray-900/90 backdrop-blur rounded-2xl border border-gray-800 p-8 shadow-2xl">
            ...
            <div className="border-t border-gray-800 pt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-xl font-semibold transition-all hover:shadow-lg"
              >
  ...
  return <QuestionnairePage type="beginner" />
}